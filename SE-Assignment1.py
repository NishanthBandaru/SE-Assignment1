...
# Course: Software Engineering, CPSC 60500, Section 01
# Date: 09/08/2024
...
def find_near_miss(n, k):
    small_miss = float('inf')
    #holding the values of x,y,z,miss for small possible miss found
    ...
    while True:
        try:
            ...
            if 3 <= n < 12:
                ...
                print("Invalid input. ensure 3 <= n < 12.")
        except ValueError:
    ...
    while True:
        try:
            ...
            if k > 10:
                ...
                print("Invalid input. ensure k > 10.")
        except ValueError:
            print("Invalid input. enter an integer.")
